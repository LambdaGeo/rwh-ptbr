...
In addition to a `.cabal` file, a package must contain a _setup_ file. This allows Cabal's build process to be heavily customised, if a package needs it. The simplest setup file looks like this.
